...
export function loadUsers(page=1, limit=10, order=null, filter=null, cb=function(){}) {
  ...
  return async function(dispatch) {
    ...
    if (200 === response.get('status')) {
      ...
      Logger.log('info', `Get API users list success. Page: ${page}, Limit: ${limit}, Order: ${order}.`);
    ...
    // get users list failure
      ...
      Logger.log('info', `Get API users list failure. Page: ${page}, Limit: ${limit}, Order: ${order}.`);
