...
export function loadAdministrators(page=1, limit=10, order=null, cb=function(){}) {
  ...
  return async function(dispatch) {
    ...
    if (200 === response.get('status')) {
      ...
      Logger.log('info', `Get API administrators list success. Page: ${page}, Limit: ${limit}, Order: ${order}.`);
    ...
    // get administrators list failure
      ...
      Logger.log('info', `Get API administrators list failure. Page: ${page}, Limit: ${limit}, Order: ${order}.`);
